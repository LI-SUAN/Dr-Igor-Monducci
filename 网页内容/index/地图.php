...
<div class="card">
    ...
    <div class="map-container">
        <img src="网页内容\index\附件\poliambulatorio_san_michele_map.png" alt="Poliambulatorio San Michele Map" class="map-image" />
    </div>
</div>
...
<div class="card">
    <div class="map-info">
        ...
        <p class="address-info">
            ...
            <a href="https://www.lazzarospallanzani.it" target="_blank" class="map-link">www.lazzarospallanzani.it</a>
        </p>
    ...
    <div class="map-container">
        <img src="网页内容\index\附件\centro_medico_lazzaro_spallanzani_map.png" alt="Centro Medico Lazzaro Spallanzani Map" class="map-image" />
    </div>
</div>
...
<div class="card">
    <div class="map-info">
        ...
        <p class="address-info">
            ...
            <a href="https://www.centropalmer.it" target="_blank" class="map-link">www.centropalmer.it</a>
        </p>
    ...
    <div class="map-container">
        <img src="网页内容\index\附件\centro_palmer_map.png" alt="Centro Palmer Map" class="map-image" />
    </div>
</div>
...
<div class="card">
    <div class="map-info">
        ...
        <p class="address-info">
            ...
            <a href="https://www.poliambulatoriofutura.it" target="_blank" class="map-link">www.poliambulatoriofutura.it</a>
        </p>
    ...
    <div class="map-container">
        <img src="网页内容\index\附件\poliambulatorio_futura_map.png" alt="Poliambulatorio Futura Map" class="map-image" />
    </div>
</div>
...
<div class="card">
    <div class="map-info">
        ...
        <p class="address-info">
            ...
            <a href="https://www.checkupservice.it" target="_blank" class="map-link">www.checkupservice.it</a>
        </p>
    ...
    <div class="map-container">
        <img src="网页内容\index\附件\check-up_service_map.png" alt="Check-Up Service Map" class="map-image" />
    </div>
</div>
